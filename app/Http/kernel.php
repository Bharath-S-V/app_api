...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'auth.driver' => \App\Http\Middleware\EnsureDriverIsAuthenticated::class,  // Custom middleware for driver auth
        'auth.web' => \App\Http\Middleware\EnsureUserIsAuthenticated::class,  // Custom middleware for user auth
