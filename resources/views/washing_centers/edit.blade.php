...
@section('title', 'Edit Washing Centres')
    ...
    <div class="page-content-wrapper">
        <div class="container-fluid">
            <div class="container mt-5">
                ...
                <form action="{{ route('washing_centers.update', $washingCenter->id) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ $washingCenter->name }}"
                            required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="contact_number" class="form-control"
                            value="{{ $washingCenter->contact_number }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="capacity" class="form-control" value="{{ $washingCenter->capacity }}"
                            required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="services-wrapper">
                            @foreach ($washingCenter->services as $index => $service)
                                <div class="service-row mb-2">
                                    <input type="text" name="services[{{ $index }}][type]"
                                        class="form-control mb-1" placeholder="Service Type" value="{{ $service['type'] }}"
                                        required>
                        ...
                        <button type="button" id="add-service" class="btn btn-secondary btn-sm mt-2">Add More
                            Service</button>
                    </div>
