...
@section('title', 'Create Washing Centres')
                    ...
                    <div class="mb-3">
                        ...
                        <div id="services-wrapper">
                            <div class="service-row mb-2">
                                <input type="text" name="services[0][type]" class="form-control mb-1"
                                    placeholder="Service Type" required>
                                <input type="number" name="services[0][price]" class="form-control" placeholder="Price"
                                    required>
                            </div>
                        </div>
